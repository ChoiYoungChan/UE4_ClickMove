...
#define UE_PROJECT_NAME UE4_ClickMove
#define UE_TARGET_NAME UE4_ClickMoveEditor
#define UE_MODULE_NAME "UE4_ClickMove"
...
#define UE4_CLICKMOVE_API DLLEXPORT
